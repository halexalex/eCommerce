...
class ReactivateEmailForm(forms.Form):
    ...
    def clean_email(self):
        ...
        if not qs.exists():
            ...
            msg = f""" This email doesn`t exist, would you like to <a href="{register_link}">register</a>?"""
...
class UserAdminCreationForm(forms.ModelForm):
    ...
    def clean_password(self):  # Check that the two password entries match
...
class LoginForm(forms.Form):
    ...
    def clean(self):
        ...
        if qs.exists():
            ...
            resend_link = reverse('account:resend-activation')
            reconfirm_msg = f"""
